...
public class PokedexActivity extends AppCompatActivity implements PokedexAdapter.ItemPokemonListener {
    ...
    private void setView() {
        ...
        gen = (int) intent.getSerializableExtra("generation");
        listPokemon = RoomDB.getInstance(this).pokemonDAO().getPokemonByGeneration(gen);

        tvTitle.setText("Generation " + gen);
        ...
        pokedexAdapter = new PokedexAdapter(PokedexActivity.this, listPokemon);
        ...
        fabFilter.setOnActionSelectedListener(new SpeedDialView.OnActionSelectedListener() {
            ...
            public boolean onActionSelected(SpeedDialActionItem actionItem) {
                switch (actionItem.getId()) {
                    case R.id.mRefresh:
                        listPokemon = RoomDB.getInstance(getApplicationContext()).pokemonDAO().getPokemonByGeneration(gen);
                    ...
                    case R.id.mSearch:
                        fabFilter.close();
                        SearchDexFragment searchDexFragment = new SearchDexFragment();
                        searchDexFragment.show(getSupportFragmentManager(), "SearchInDex");
                        break;
                }
                return true;
            }
